...
public interface TbSpecGroupService extends IService<TbSpecGroup> {
    ...
    List<SpecGroupDTO> findSpecGroupByCategoryId(Long categoryId);

    void saveGroup(SpecGroupDTO specGroupDTO);

    void updateGroup(SpecGroupDTO specGroupDTO);

    void deleteGroupAndParams(Long id);
